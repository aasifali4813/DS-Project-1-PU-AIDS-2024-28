...
def compute_normalizing_probability(placement_equals_0_likelihood, placement_equals_1_likelihood):
...
def determine_placement_posterior_probability(input_features):
    ...
    for input_feat, input_feat_value in zip(config.NEW_DATA_COLUMN_NAMES, new_input_features):
    ...
    normalizing_probability = compute_normalizing_probability(placement_equals_0_likelihood,
                                                              placement_equals_1_likelihood)
    placement_equals_0_posterior = placement_equals_0_posterior/normalizing_probability
    placement_equals_1_posterior = placement_equals_1_posterior/normalizing_probability
